    ...
    <>
      <Tabs defaultIndex={0}>
        <motion.div
          ...
          <TabList className=' flex flex-col justify-center items-center mx-auto rounded-xl mb-16 w-full dark:bg-primary-500 md:w-max md:flex-row'>
        ...
        <TabPanel className='w-full flex items-center flex-col-reverse md:flex-row-reverse transition-all'>
          ...
          <motion.div
            ...
            className='relative'>
            {!isLoaded && (
              <div className=' absolute top-0 rounded-lg z-50 bg-primary-400 animate-pulse w-full ' />
            )}
            <img
