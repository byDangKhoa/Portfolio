      ...
      <motion.div
        ...
        <div className="flex justify-end items-center px-0 py-4 gap-4 sm:px-6 lg:py-8 lg:gap-10">
          <div className="mr-auto">
            <a href="#home">
              {darkTheme ? (
                <img className="h-12 w-auto" src={images.brandLogoDark} alt="brand icon" height={12} width={245} />
              ) : (
                <img className="h-12 w-auto" src={images.brandLogoLight} alt="brand icon" height={12} width={245} />
              )}
            </a>
          </div>
          <div className="-mr-2 -my-2 lg:hidden">
            <Popover.Button className="rounded-md p-2 inline-flex items-center justify-center text-primary focus:outline-none focus:ring-2 focus:ring-inset focus:ring-secondary dark:text-white">
              ...
              <MenuAlt1Icon className="h-6 w-6 transform rotate-180" aria-hidden="true" />
            </Popover.Button>
          </div>
          ...
          <div className="hidden lg:flex">
            <ContactModal toggleOpen={modalIsOpen} toggleClose={toggleModal}></ContactModal>
          </div>
          <motion.div
              ...
              <div className="pt-5 pb-6 px-5">
                ...
                <div className="mt-6">
                  <nav className="grid grid-cols-1 gap-7">
                    {navlinks.map((navlink) => (
                      <a key={navlink.name} href={navlink.href} className="text-base font-medium text-white w-max relative">
                        {t(navlink.name)}
                        {/* {navlink.type === 'new' && (
