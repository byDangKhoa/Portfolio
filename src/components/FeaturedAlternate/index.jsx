      ...
      <div className="flex flex-col gap-20 mt-32 md:gap-40 lg:gap-60">
        {projects.map((proj) => (
          <motion.div
            ...
            <span className="featured-no absolute text-[10rem] text-primary-300 -top-32 opacity-20 hidden xl:block">0{proj.id}</span>
            <div className="w-full z-10 md:w-1/2">
              <h3 className="text-primary text-4xl font-semibold mb-4 dark:text-white">{t(proj.heading)}</h3>
              <RichText className="text-primary-400 text-base dark:text-neutral-300" content={t(proj.description)} />
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center">
                  <span className="uppercase px-2 bg-white text-sm text-gray-500 dark:bg-primary">{t('techused')}</span>
                </div>
              </div>
