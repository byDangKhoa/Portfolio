...
const TwoColumnCard = () => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="grid grid-cols-1 gap-10 items-center md:grid-cols-2 w-full">
      <motion.div
        variants={{
          offscreen: {
            y: 150
        ...
        <h6 className="text-2xl font-bold text-primary mb-4 dark:text-white">
          <a href="https://vslsoft.com/" target="_blank" className="hover:underline">
            VSL Software
          </a>
        ...
        <div className="relative mb-4">
          ...
          <div className="relative flex justify-center">
            <span className="uppercase px-2 bg-gray-50 text-sm text-gray-500 dark:bg-primary-500">{t('duty')}</span>
          </div>
        </div>
      ...
      <motion.div
        ...
        <h6 className="text-2xl font-bold text-primary mb-4 dark:text-white">
          <a href="https://vslsoft.com/" target="_blank" className="hover:underline">
            TradeCoin Việt Nam & K300 Ventures
          </a>
          <span className="mt-4 text-xs flex items-center justify-start uppercase text-neutral-600 dark:text-neutral-300">
            <CalendarIcon className="h-4 mr-2 text-neutral-600 dark:text-neutral-300" />
            03/2023 - NOW
