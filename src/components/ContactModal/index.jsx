...
const ContactModal = ({ toggleOpen, toggleClose, children, className }) => {
  ...
  const [viLanguage, setViLanguage] = useState(localStorage.getItem('i18nextLng') === 'vi');
  ...
  return (
    <div className={`w-full`}>
      ...
      <StyledButton viLanguage={viLanguage} style={{ borderRadius: '6px 0 0 6px', marginRight: 0 }} onClick={onChangeVi}>
        VN
      </StyledButton>
      <StyledButton viLanguage={!viLanguage} style={{ borderRadius: '0 6px 6px 0', marginLeft: 0 }} onClick={onChangeEn}>
        EN
      </StyledButton>
      ...
      <Modal
        ...
        <button className="absolute flex justify-end right-4 top-4 z-[150] text-white dark:text-primary-500" onClick={toggleClose}>
          {' '}
