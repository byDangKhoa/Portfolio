    ...
    <div>
      {loading ? (
        <>
          <NavBar />
          <HeroSection />
          <SectionWrapper id="about" heading={t('about').toUpperCase()}>
            <TabSection />
          </SectionWrapper>
          <SectionWrapper id="experience" heading={t('experience').toUpperCase()}>
            <TwoColumnCard />
          </SectionWrapper>
          <SectionWrapper id="projects" heading={t('projects').toUpperCase()}>
            <FeaturedAlternate />
          </SectionWrapper>
          <Footer />
        </>
